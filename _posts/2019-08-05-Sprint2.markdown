...
![](/assets/Confirmpassword.png) | ![](/assets/avoidingview.png)
...
![](/assets/Highlight2.png) | ![](/assets/highlightinput.png)
...
![](/assets/Feature13doc.png)

I continued to document my progress on tickets for good communication with Joon.
...
![](/assets/Oldeditdetails.png) | ![](/assets/editDetails.png)
...
| [!(/assets/earlydesign.png)] | [!(/assets/design2.jpg)] | [!(/assets/timer.png)] |

Above you can see my design process of creating the timer interface. I sectioned the page up into two, the bottom buttons and real-time statistics. I used the row property in my style sheet to lay them out evenly and used 33% width to break up the steps, duration and distance stats.

<br/><br/>
<br/><br/>

![](/assets/ButtonsStyleDisable.png)
